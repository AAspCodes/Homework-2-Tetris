...
//	public String diagnos(Piece piece, Grid grid) {
//		for (Point point: piece.getLocations()) {
//			System.out.println("row" + point.getX() + " col " + point.getY());
//		}
//		
//		for (int r = 0; r < grid.HEIGHT; r++) {
//			for (int c = 0; c < grid.WIDTH; c++) {
//				System.out.println("row: " + r + " col: " + c + " : " + grid.isSet(r, c));
//			}
//		}
