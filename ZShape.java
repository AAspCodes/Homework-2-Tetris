...
public class ZShape extends AbstractPiece implements Piece {
	...
	public ZShape(int row, int col, Grid grid) {
		...
		// Create the squares
		square[0] = new Square(grid, row, col - 1, Color.red, true);
		square[1] = new Square(grid, row, col, Color.red, true);
		square[2] = new Square(grid, row + 1, col, Color.red, true);
		square[3] = new Square(grid, row + 1, col + 1, Color.red, true);
	}
